...
#pragma NDIS_INIT_FUNCTION(Windowsndislwf1RegisterDevice)


_IRQL_requires_max_(PASSIVE_LEVEL)
NDIS_STATUS
Windowsndislwf1RegisterDevice(
    VOID
    )
{
    ...
    DEBUGP(DL_TRACE, "==>Windowsndislwf1RegisterDevice\n");
   
    
    NdisZeroMemory(DispatchTable, (IRP_MJ_MAXIMUM_FUNCTION+1) * sizeof(PDRIVER_DISPATCH));
    
    DispatchTable[IRP_MJ_CREATE] = Windowsndislwf1Dispatch;
    DispatchTable[IRP_MJ_CLEANUP] = Windowsndislwf1Dispatch;
    DispatchTable[IRP_MJ_CLOSE] = Windowsndislwf1Dispatch;
    DispatchTable[IRP_MJ_DEVICE_CONTROL] = Windowsndislwf1DeviceIoControl;
    ...
    DEBUGP(DL_TRACE, "<==Windowsndislwf1RegisterDevice: %x\n", Status);
...
_IRQL_requires_max_(PASSIVE_LEVEL)
VOID
Windowsndislwf1DeregisterDevice(
    VOID
    )
...
_Use_decl_annotations_                
NTSTATUS
Windowsndislwf1DeviceIoControl(
    PDEVICE_OBJECT        DeviceObject,
    PIRP                  Irp
    )
{
