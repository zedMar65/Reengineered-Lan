...
#define FILTER_FRIENDLY_NAME        L"Windows_ndislwf1 NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{d160b69a-9ac8-4525-a123-1fbe7515b4dc}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"Windows_ndislwf1"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\DosDevices\\Windows_ndislwf1"
#define NTDEVICE_STRING             L"\\Device\\Windows_ndislwf1"
...
DRIVER_DISPATCH Windowsndislwf1Dispatch;

DRIVER_DISPATCH Windowsndislwf1DeviceIoControl;
